...
WebUI.setText(findTestObject('login_zlibrary/Page_Z-Library Project/input__email'), 'phnlyma@gmail.com')

WebUI.setText(findTestObject('login_zlibrary/Page_Z-Library Project/input__password'), 'FABbr70%#$&')
